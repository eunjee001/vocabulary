...
import com.kkyoungs.vocabulary.databinding.ItemWordBinding

class WordAdapter(val list : MutableList<Word>, private val itemClickListener: ItemClickListener?) : RecyclerView.Adapter<WordAdapter.WordViewHolder>() {
